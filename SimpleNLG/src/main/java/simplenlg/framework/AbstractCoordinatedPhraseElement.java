 ...
 * 
 */
public abstract class AbstractCoordinatedPhraseElement extends NLGElement {
	
	public abstract List<String> getPluralCoordinators();
	 ...
	 */
	public AbstractCoordinatedPhraseElement() {
		super();
		this.setFeature(Feature.CONJUNCTION, getCoordinator()); //$NON-NLS-1$
	}
	 ...
	 */
	public AbstractCoordinatedPhraseElement(Object coordinate1, Object coordinate2) {
	...
	public boolean checkIfPlural() {
		...
		if (size == 1)
			...
			return getPluralCoordinators().contains(getConjunction());
	}
}
