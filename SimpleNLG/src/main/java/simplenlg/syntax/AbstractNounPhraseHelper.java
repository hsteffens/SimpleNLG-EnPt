...
public abstract class AbstractNounPhraseHelper {
	...
	public abstract NLGElement createPronoun(SyntaxProcessor parent, PhraseElement phrase);
	public abstract void sortElements(ListElement realisedElement);
