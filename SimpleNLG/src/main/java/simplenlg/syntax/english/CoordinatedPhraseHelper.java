...
public abstract class CoordinatedPhraseHelper {
	 ...
	 */
	public static NLGElement realise(SyntaxProcessor parent,
			AbstractCoordinatedPhraseElement phrase) {
		...
		if (phrase != null) {
			...
			AbstractCoordinatedPhraseElement coordinated = null;
			if (phrase instanceof PortugueseCoordinatedPhraseElement) {
				coordinated = new PortugueseCoordinatedPhraseElement();
			} else{
				coordinated = new EnglishCoordinatedPhraseElement();
			}
	 ...
	 *            coordination.
	 */
	private static void setChildFeatures(AbstractCoordinatedPhraseElement phrase,
			NLGElement child) {
