 ...
 * 
 */
public abstract class AbstractSPhraseSpec extends PhraseElement {
	
	public abstract String getComplementiserWord();
	 ...
	 */
	public AbstractSPhraseSpec(NLGFactory phraseFactory) {
		...
		setFeature(Feature.COMPLEMENTISER, phraseFactory.createWord(
				getComplementiserWord(), LexicalCategory.COMPLEMENTISER)); //$NON-NLS-1$
	...
	public void addPreModifier(NLGElement newPreModifier) {
		...
		if (verbPhrase != null) {
			...
			} else if (verbPhrase instanceof AbstractCoordinatedPhraseElement) {
				((AbstractCoordinatedPhraseElement) verbPhrase)
	...
	public void setSubject(Object subject) {
		...
		if (subject instanceof PhraseElement
				|| subject instanceof AbstractCoordinatedPhraseElement)
