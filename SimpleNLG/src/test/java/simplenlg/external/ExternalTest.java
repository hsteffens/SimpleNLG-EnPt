...
public class ExternalTest {
	...
	@Before
	public void setup() {
		lexicon = Lexicon.getEnglishDefaultLexicon();
		phraseFactory = new EnglishNLGFactory(lexicon);
	...
	public void forcherTest() {
		...
		AbstractSPhraseSpec s2 = this.phraseFactory.createClause();
	...
	public void dwightTest() {
		...
		AbstractCoordinatedPhraseElement coordNoun1 = new EnglishCoordinatedPhraseElement(
				noun1, noun2);
		...
		AbstractCoordinatedPhraseElement coord1 = new EnglishCoordinatedPhraseElement(noun2,
				noun3);
	...
	public void novelliTest() {
		...
		AbstractSPhraseSpec run = this.phraseFactory.createClause(
		...
		AbstractSPhraseSpec think = this.phraseFactory.createClause("I", "think"); //$NON-NLS-1$ //$NON-NLS-2$
		think.setObject(run);
	...
	public void wissnerTest() {
		...
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHAT_OBJECT);
	...
	public void phanTest() {
		// Thomas Phan's text
	      ...
	      AbstractSPhraseSpec newSentence = this.phraseFactory.createClause();
	...
	public void kerberTest() {
        ...
        AbstractSPhraseSpec sp =  this.phraseFactory.createClause("he", "need");
        AbstractSPhraseSpec secondSp = this.phraseFactory.createClause();
        ...
        AbstractSPhraseSpec sp2 =  this.phraseFactory.createClause("he", "give");
	...
	public void stephensonTest() {
		...
		AbstractSPhraseSpec qs2 = this.phraseFactory.createClause();
		...
		qs2.setFeature(Feature.INTERROGATIVE_TYPE,EnglishInterrogativeType.HOW_MANY);
	...
	public void pierreTest() {
		// John Pierre's test
		AbstractSPhraseSpec p = this.phraseFactory.createClause("Mary", "chase", "George");
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHAT_OBJECT);
		Assert.assertEquals("What does Mary chase?", realiser.realiseSentence(p));

		p = this.phraseFactory.createClause("Mary", "chase", "George");
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);
		Assert.assertEquals("Does Mary chase George?", realiser.realiseSentence(p));

		p = this.phraseFactory.createClause("Mary", "chase", "George");
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHERE);
		Assert.assertEquals("Where does Mary chase George?", realiser.realiseSentence(p));

		p = this.phraseFactory.createClause("Mary", "chase", "George");
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHY);
		Assert.assertEquals("Why does Mary chase George?", realiser.realiseSentence(p));

		p = this.phraseFactory.createClause("Mary", "chase", "George");
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.HOW);
	...
	public void data2TextTest() {
		...
		AbstractSPhraseSpec p = this.phraseFactory.createClause("the dog", "weigh", "12");
		...
		AbstractSPhraseSpec sentence2 = this.phraseFactory.createClause();
		...
		AbstractSPhraseSpec weather1 = this.phraseFactory.createClause("SE 10-15", "veer", "S 15-20");
		...
		AbstractSPhraseSpec weather2 = this.phraseFactory.createClause("cloudy and misty", "be", "XXX");
		...
		AbstractSPhraseSpec weather3 = this.phraseFactory.createClause("S 15-20", "increase", "20-25");
		...
		// conjoined test
		AbstractSPhraseSpec weather4 = this.phraseFactory.createClause("S 20-25", "back", "SSE");
		weather4.setFeature(Feature.FORM, Form.GERUND);
		weather4.getSubject().setFeature(Feature.ELIDED, true);
		
		AbstractCoordinatedPhraseElement coord = new EnglishCoordinatedPhraseElement();
		...
		// no verb
		AbstractSPhraseSpec weather5 = this.phraseFactory.createClause("rain", null, "likely");
	...
	private NLGElement commentPhrase(String name){  // used by testRafael
		AbstractSPhraseSpec s = this.phraseFactory.createClause();
	...
	public void wikipediaTest() {
		...
		AbstractSPhraseSpec sentence = this.phraseFactory.createClause(subject, "smoke");
		sentence.setFeature(Feature.NEGATED, true);
		Assert.assertEquals("The women do not smoke.", realiser.realiseSentence(sentence));

		// aggregation
		AbstractSPhraseSpec s1 = this.phraseFactory.createClause("the man", "be", "hungry");
		AbstractSPhraseSpec s2 = this.phraseFactory.createClause("the man", "buy", "an apple");
	...
	public void leanTest() {
		// A Lean's test
		AbstractSPhraseSpec sentence = this.phraseFactory.createClause();
		sentence.setVerb("be");
		sentence.setObject("a ball");
		sentence.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHAT_SUBJECT);
		...
		AbstractSPhraseSpec p = this.phraseFactory.createClause(); 
        ...
        AbstractSPhraseSpec test = this.phraseFactory.createClause();
        ...
        test.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHY);
