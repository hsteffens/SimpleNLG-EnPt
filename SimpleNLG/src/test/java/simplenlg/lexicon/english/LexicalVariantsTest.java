...
public class LexicalVariantsTest {
	...
	public void setUp() {
        ...
        try {
            ...
            if ("NIH".equals(type)) {
                ...
                // XML lexicon
                lexicon = new EnglishXMLLexicon(prop.getProperty("XML_FILENAME"));
            }
        } catch (Exception e) {
            this.lexicon = new NIHDBLexicon(DB_FILENAME);
        }

		this.factory = new EnglishNLGFactory(lexicon);
	...
	public void spellingVariantsInVPTest() {
		...
		AbstractSPhraseSpec s = this.factory.createClause(this.factory
