...
public class XMLLexiconTest {
	...
	EnglishXMLLexicon lexicon = null;
	...
	public void setUp() {
		...
		//this.lexicon = new XMLLexicon(XML_FILENAME); // omit, use default
														// lexicon instead
		this.lexicon = new EnglishXMLLexicon("default-lexicon.xml", "/simplenlg/lexicon/default-lexicon.xml");
	...
	public void xmlLexiconImmutabilityTest() {
	    NLGFactory factory = new EnglishNLGFactory(lexicon);
	    ...
	    wall.setPlural(true);       
	    AbstractSPhraseSpec sentence = factory.createClause("motion", "observe");
	    ...
	    String realiseSentence = realiser.realiseSentence(sentence);
