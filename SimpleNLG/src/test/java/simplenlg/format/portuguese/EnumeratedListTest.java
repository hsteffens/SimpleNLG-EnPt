...
public class EnumeratedListTest {
	...
	public void bulletList() {
		...
		String expectedOutput = "<h1>Document</h1>" + "<p>" + "<ul>" + "<li>Esta é a primeira sentença.</li>"
		                        + "<li>Esta é a segunda sentença.</li>" + "</ul>" + "</p>";
	...
	public void enumeratedList() {
		...
		paragraph.addComponent(list);
		document.addComponent(paragraph);
		String expectedOutput = "<h1>Document</h1>" + "<p>" + "<ol>" + "<li>Esta é a primeira sentença.</li>"
		                        + "<li>Esta é a segunda sentença.</li>" + "</ol>" + "</p>";
