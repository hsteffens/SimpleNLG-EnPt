...
public class AdjectivePhraseTest extends SimpleNLG4Test {
	...
	public void testAdj() {
		...
		AbstractCoordinatedPhraseElement coordap = new EnglishCoordinatedPhraseElement(
		...
		AbstractCoordinatedPhraseElement coord2 = new EnglishCoordinatedPhraseElement(coordap,
				this.stunning);
		Assert.assertEquals(
		...
		// and stunning"
		AbstractCoordinatedPhraseElement preMod = new EnglishCoordinatedPhraseElement(
