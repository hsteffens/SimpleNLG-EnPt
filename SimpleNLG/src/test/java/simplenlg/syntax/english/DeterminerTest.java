...
public class DeterminerTest {
	...
	@Before
	public void setUp() {
		this.lexicon = new EnglishXMLLexicon("default-lexicon.xml", "/simplenlg/lexicon/default-lexicon.xml");  // built in lexicon

		this.phraseFactory = new EnglishNLGFactory(this.lexicon);
	...
	public void testSingluarThisDeterminerNPObject() {
		AbstractSPhraseSpec sentence_1 = this.phraseFactory.createClause();
