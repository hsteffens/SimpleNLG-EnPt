...
public class InterrogativeTest extends SimpleNLG4Test {
	...
	/** The s5. */
	AbstractSPhraseSpec s1, s2, s3, s4, s5;
	...
	protected void setUp() {
		...
		AbstractCoordinatedPhraseElement subjects = new EnglishCoordinatedPhraseElement(
	...
	public void testSimpleQuestions() {
		...
		this.s1.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);

		NLGFactory docFactory = new EnglishNLGFactory(this.lexicon);
		...
		this.s2.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);
		...
		this.s3.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);
		...
		this.s4.addFrontModifier("tomorrow"); //$NON-NLS-1$
		this.s4.setFeature(Feature.TENSE, Tense.FUTURE);
		this.s4.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);
		Assert.assertEquals(
	...
	public void testCoordinateVPQuestions() {
		...
		setUp();
		AbstractCoordinatedPhraseElement complex = new EnglishCoordinatedPhraseElement(
				this.kiss, this.walk);
		...
		// wide-scope aux
		setUp();
		subjects = new EnglishCoordinatedPhraseElement(
				this.phraseFactory.createNounPhrase("Jane"), //$NON-NLS-1$
				this.phraseFactory.createNounPhrase("Andrew")); //$NON-NLS-1$
		this.kiss.addComplement(this.dog);
		this.walk.addComplement(this.inTheRoom);
		complex = new EnglishCoordinatedPhraseElement(this.kiss, this.walk);
		this.s4 = this.phraseFactory.createClause(subjects, complex);
		this.s4.setFeature(Feature.CUE_PHRASE, "however"); //$NON-NLS-1$
		this.s4.addFrontModifier("tomorrow"); //$NON-NLS-1$
		this.s4.setFeature(Feature.TENSE, Tense.FUTURE);
	...
	public void testSimpleQuestions2() {
		...
		s.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.YES_NO);
		Assert.assertEquals("does the woman kiss the man", this.realiser //$NON-NLS-1$
		...
		s = this.phraseFactory.createClause("the woman", "kiss", //$NON-NLS-1$ //$NON-NLS-2$
				"the man"); //$NON-NLS-1$
		s.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHO_SUBJECT);
		...
		s = this.phraseFactory.createClause("the woman", "kiss", //$NON-NLS-1$ //$NON-NLS-2$
				"the man"); //$NON-NLS-1$
		s.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHO_OBJECT);
	...
	public void testWHQuestions() {
		...
		this.s4.setFeature(Feature.INTERROGATIVE_TYPE,
				EnglishInterrogativeType.WHO_SUBJECT);
		Assert.assertEquals(
		...
		setUp();
		this.s4.setFeature(Feature.INTERROGATIVE_TYPE,
				EnglishInterrogativeType.WHAT_OBJECT);
		Assert.assertEquals(
		...
		setUp();
		this.s4.setFeature(Feature.PASSIVE, true);
		this.s4.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.HOW);
		Assert.assertEquals(
		...
		setUp();
		this.s4.setFeature(Feature.PASSIVE, true);
		this.s4.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHY);
		Assert.assertEquals(
		...
		this.s3.setFeature(Feature.INTERROGATIVE_TYPE,
				EnglishInterrogativeType.WHO_INDIRECT_OBJECT);
	...
	public void testProgrssiveWHSubjectQuestions() {
		...
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHO_SUBJECT);
	...
	public void testTutorialQuestions() {
		...
		p = this.phraseFactory.createClause("Mary", "chase", //$NON-NLS-1$ //$NON-NLS-2$
				"George"); //$NON-NLS-1$
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHO_OBJECT);
	...
	public void testModalWHSubjectQuestion() {
		AbstractSPhraseSpec p = this.phraseFactory.createClause(this.dog, "upset",
				this.man);
		...
		p.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHAT_SUBJECT);
	...
	public void testBeQuestions() {
		...
		AbstractSPhraseSpec p2 = this.phraseFactory.createClause("Mary", "be",
				"beautiful");
		p2.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHY);
		Assert.assertEquals("why is Mary beautiful", this.realiser.realise(p2)
				.getRealisation());

		p2.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHERE);
		Assert.assertEquals("where is Mary beautiful", this.realiser.realise(p2)
				.getRealisation());
		
		p2.setFeature(Feature.INTERROGATIVE_TYPE, EnglishInterrogativeType.WHO_SUBJECT);
	...
	public void testSimpleBeWHQuestions() {
		AbstractSPhraseSpec p = this.phraseFactory.createClause("I", "be");
	...
	public void testHowPredicateQuestion() {
		...
		test.setFeature(Feature.INTERROGATIVE_TYPE,
				EnglishInterrogativeType.HOW_PREDICATE);
	...
	public void testWhatObjectInterrogative() {
		Lexicon lexicon = Lexicon.getEnglishDefaultLexicon();
		NLGFactory nlg = new EnglishNLGFactory(lexicon);
		Realiser realiser = new Realiser(lexicon);

		// Case 1, no object is explicitly given:
		AbstractSPhraseSpec clause = nlg.createClause("you", "think");
