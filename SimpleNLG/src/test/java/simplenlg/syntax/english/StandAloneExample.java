...
public class StandAloneExample {
	...
	public static void main(String[] args) {
		...
		// set up
		Lexicon lexicon = new EnglishXMLLexicon("default-lexicon.xml", "/simplenlg/lexicon/default-lexicon.xml");                          // default simplenlg lexicon
		...
		AbstractSPhraseSpec johnGoToThePark = nlgFactory.createClause("John",      // create sentence
				"go", toThePark);
