...
public class TutorialTest {
	...
	public void section3_Test() {
		Lexicon lexicon = Lexicon.getEnglishDefaultLexicon();                         // default simplenlg lexicon
		NLGFactory nlgFactory = new EnglishNLGFactory(lexicon);             // factory based on lexicon
	...
	public void section6_Test() {
		...
		p.setFeature(Feature.INTERROGATIVE_TYPE,
				EnglishInterrogativeType.YES_NO);
		output = realiser.realiseSentence(p);
	...
	public void section11_Test() {
		...
		AbstractSPhraseSpec pA = nlgFactory.createClause( "Mary", "chase", "the monkey" );
		...
		AbstractSPhraseSpec pB = nlgFactory.createClause( "Mary", "chase", "the monkey" );
	...
	public void section13_Test() {
		...
		AbstractSPhraseSpec s1 = nlgFactory.createClause( "my cat",   "like", "fish"  );
		AbstractSPhraseSpec s2 = nlgFactory.createClause( "my dog",  "like",  "big bones" );
		AbstractSPhraseSpec s3 = nlgFactory.createClause( "my horse", "like", "grass" );		
		...
		AbstractSPhraseSpec p = nlgFactory.createClause( "I", "be",  "happy" );
		AbstractSPhraseSpec q = nlgFactory.createClause( "I", "eat", "fish" );
	...
	public void section14_Test() {
		...
		AbstractSPhraseSpec p1 = nlgFactory.createClause( "Mary", "chase", "the monkey" );
		AbstractSPhraseSpec p2 = nlgFactory.createClause( "The monkey", "fight back" );
		AbstractSPhraseSpec p3 = nlgFactory.createClause( "Mary", "be", "nervous" );
