...
public class PhraseSpecTest extends SimpleNLG4Test {
	...
	public void emptyPhraseRealisationTest() {
		AbstractSPhraseSpec emptyClause = this.phraseFactory.createClause();
	...
	public void testSPhraseSpec() {
		...
		AbstractSPhraseSpec c1 = (AbstractSPhraseSpec) phraseFactory.createClause();
		c1.setVerb("give");
		c1.setSubject("John");
		...
		AbstractSPhraseSpec c2 = (AbstractSPhraseSpec) phraseFactory.createClause();
		c2.setVerb("see");
