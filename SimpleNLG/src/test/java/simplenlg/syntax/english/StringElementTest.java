...
public class StringElementTest {
	...
	public void tailNPStringElementTest() {
		AbstractSPhraseSpec senSpec = this.phraseFactory.createClause();
	...
	public void aggregationStringElementTest() {
		...
		AbstractCoordinatedPhraseElement coordinate = 
	    ...
	    AbstractSPhraseSpec sentence = phraseFactory.createClause();
	...
	public void nullAndEmptyStringElementTest() {
		...
		AbstractSPhraseSpec test1 = this.phraseFactory.createClause("a unicorn", "be", "regarded as a");
		...
		AbstractSPhraseSpec test2 = this.phraseFactory.createClause("a unicorn", "be", "regarded as a");
		...
		AbstractSPhraseSpec test3 = this.phraseFactory.createClause("a unicorn", "be", "regarded as a");
		...
		AbstractSPhraseSpec test4 = this.phraseFactory.createClause("a unicorn", "be", "regarded as a");
