...
public class PrepositionalPhraseTest extends SimpleNLG4Test {
	...
	public void testComplementation() {
		...
		this.inTheRoom.addComplement(new EnglishCoordinatedPhraseElement(
	...
	public void testCoordination() {
		...
		// new coordinate
		AbstractCoordinatedPhraseElement coord2 = new EnglishCoordinatedPhraseElement(
		...
		AbstractCoordinatedPhraseElement coord3 = new EnglishCoordinatedPhraseElement(coord1,
				coord2);
