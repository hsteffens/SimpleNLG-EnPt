...
public class HTMLFormatterTest extends SimpleNLG4Test {
	...
	public final void testWebPageContent( ) {
		...
		AbstractSPhraseSpec p1 = phraseFactory.createClause( "Mary", "chase", "the monkey" ) ;
		AbstractSPhraseSpec p2 = phraseFactory.createClause( "the monkey", "fight back" ) ;
		AbstractSPhraseSpec p3 = phraseFactory.createClause( "Mary", "be", "nervous" ) ;
