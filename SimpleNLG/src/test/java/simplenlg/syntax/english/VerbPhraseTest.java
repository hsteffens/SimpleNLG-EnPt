...
public class VerbPhraseTest extends SimpleNLG4Test {
	...
	public void complementationTest() {
		...
		AbstractCoordinatedPhraseElement mary2 = new EnglishCoordinatedPhraseElement(mary,
	...
	public void complementationTest_2() {
		...
		this.give.clearComplements();
		this.give.addComplement(this.dog);
		AbstractCoordinatedPhraseElement womanBoy = new EnglishCoordinatedPhraseElement(
				this.woman, this.boy);
	...
	public void clausalComplementTest() {
		...
		AbstractCoordinatedPhraseElement maryAndSusan = new EnglishCoordinatedPhraseElement(
		...
		AbstractCoordinatedPhraseElement s3 = new EnglishCoordinatedPhraseElement(s, s2);
		...
		// Create a sentence first
		maryAndSusan = new EnglishCoordinatedPhraseElement(
				this.phraseFactory.createNounPhrase("Mary"), //$NON-NLS-1$
				this.phraseFactory.createNounPhrase("Susan")); //$NON-NLS-1$
		...
		s3 = new EnglishCoordinatedPhraseElement(s, s2);
		this.say.addComplement(s3);
		this.say.setFeature(Feature.TENSE,Tense.PAST);
		this.say.addPostModifier(this.behindTheCurtain);
	...
	public void coordinationTest() {
		...
		AbstractCoordinatedPhraseElement coord1 = new EnglishCoordinatedPhraseElement(
				this.kiss, this.kick);
