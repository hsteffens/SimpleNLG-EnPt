...
public class CoordinationTest extends SimpleNLG4Test {
	...
	public void emptyCoordinationTest() {
		...
		AbstractCoordinatedPhraseElement coord = this.phraseFactory
	...
	public void testModifiedCoordVP() {
		...
		AbstractSPhraseSpec s = this.phraseFactory.createClause("Jake", coord);
	...
	public void testNullConjunction() {
		AbstractSPhraseSpec p = this.phraseFactory.createClause("I", "be", "happy");
		AbstractSPhraseSpec q = this.phraseFactory.createClause("I", "eat", "fish");
		AbstractCoordinatedPhraseElement pq = this.phraseFactory
				.createCoordinatedPhrase();
		pq.addCoordinate(p);
		pq.addCoordinate(q);
	...
	public void testNegationFeature() {
		AbstractSPhraseSpec s1 = this.phraseFactory
				.createClause("he", "have", "asthma");
		AbstractSPhraseSpec s2 = this.phraseFactory.createClause("he", "have",
				"diabetes");
