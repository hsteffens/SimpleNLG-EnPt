...
public class NounPhraseTest extends SimpleNLG4Test {
	...
	public void testPronominalisation2() {
		...
		AbstractSPhraseSpec sent = phraseFactory.createClause(pro, "like", "John");
		Assert
	...
	public void testCoordination() {
		...
		AbstractCoordinatedPhraseElement cnp1 = new EnglishCoordinatedPhraseElement(this.dog,
				this.woman);
		// simple coordination
	...
	public void testCoordination2() {
		...
		AbstractCoordinatedPhraseElement cnp2 = new EnglishCoordinatedPhraseElement(this.dog,
				this.woman);
  ...
  public void testPluralNounsBelongingToASingular() {
    ...
    AbstractSPhraseSpec sent = this.phraseFactory.createClause("I", "count up");
  ...
  public void testSingularNounsBelongingToAPlural() {
    ...
    AbstractSPhraseSpec sent = this.phraseFactory.createClause("I", "clean");
    sent.setFeature(Feature.TENSE, Tense.PAST);
	...
	public void testAppositivePostmodifier() {
		...
		AbstractSPhraseSpec _sent = this.phraseFactory.createClause(_dog, "ran");		
