...
public class ClauseTest extends SimpleNLG4Test {
	...
	/** The s4. */
	AbstractSPhraseSpec s1, s2, s3, s4;
	...
	protected void setUp() {
		...
		AbstractCoordinatedPhraseElement subject = this.phraseFactory
	...
	public void testVPNegation() {
		...
		AbstractSPhraseSpec s = phraseFactory.createClause(phraseFactory
	...
	public void testForm() {
		...
		AbstractCoordinatedPhraseElement subject = new EnglishCoordinatedPhraseElement(
	...
	public void testForm2() {
		...
		AbstractSPhraseSpec temp = this.phraseFactory.createClause(this.s4, "be", //$NON-NLS-1$
		...
		AbstractSPhraseSpec temp2 = this.phraseFactory.createClause("I", "tell", temp); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testGerundsubject() {
		...
		AbstractSPhraseSpec _s4 = this.phraseFactory.createClause();
	...
	public void testComplexSentence1() {
		setUp();
		// the man's giving the woman John's flower upset Peter
		AbstractSPhraseSpec complexS = this.phraseFactory.createClause();
		...
		AbstractSPhraseSpec s5 = this.phraseFactory.createClause();
		...
		AbstractCoordinatedPhraseElement coord = new EnglishCoordinatedPhraseElement(this.s3,
				s5);
		...
		AbstractSPhraseSpec s6 = this.phraseFactory.createClause();
		...
		coord = new EnglishCoordinatedPhraseElement(this.s3, s5);
		complexS.setSubject(coord);
		this.s3.setFeature(Feature.PERFECT, true);
		Assert.assertEquals(
	...
	public void testComplexSentence3() {
		...
		AbstractCoordinatedPhraseElement coord2 = new EnglishCoordinatedPhraseElement(this.s1,
				this.s3);
	...
	public void testPassive() {
		...
		AbstractSPhraseSpec _s1 = this.phraseFactory.createClause(null,
		...
		AbstractSPhraseSpec _s2 = this.phraseFactory.createClause(null, "give", //$NON-NLS-1$
		...
		PhraseElement _s3 = this.phraseFactory.createClause(
				new EnglishCoordinatedPhraseElement("my dog", "your cat"), "chase", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				"George"); //$NON-NLS-1$
		...
		_s3 = this.phraseFactory.createClause(new EnglishCoordinatedPhraseElement(
	...
	public void testPassiveWithPPCompl() {
		...
		AbstractSPhraseSpec _s1 = this.phraseFactory.createClause(subject,
	...
	public void subclausesTest() {
		...
		AbstractSPhraseSpec sub2 = this.phraseFactory.createClause();
		...
		// main sentence
		AbstractSPhraseSpec s = this.phraseFactory.createClause("there", "be", acct);
		s.setFeature(Feature.TENSE, Tense.PAST);
